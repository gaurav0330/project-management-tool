...
const CreateTaskModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <>
      ...
      >
        <motion.div
          className="bg-bg-primary-light dark:bg-bg-primary-dark rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-gray-200/20 dark:border-gray-700/20"
