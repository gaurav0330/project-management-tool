      ...
      <div className="p-6">
        <div className="animate-pulse space-y-4">
          ...
          <div className="flex gap-6">
            <div className="w-1/2 h-80 bg-gray-200 dark:bg-gray-700 rounded-xl"></div>
      ...
      <div className="p-6 text-center">
        <div className="flex flex-col items-center gap-4">
          <div className="w-16 h-16 bg-bg-accent-light dark:bg-bg-accent-dark rounded-full flex items-center justify-center">
            <Users className="w-8 h-8 text-txt-secondary-light dark:text-txt-secondary-dark" />
          </div>
          <div>
            <h3 className="text-lg font-semibold text-heading-primary-light dark:text-heading-primary-dark mb-2">
      ...
      >
        ...
        {topPerformer && (
          <motion.div
            ...
            className="mb-6 p-4 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-xl border border-yellow-200/50 dark:border-yellow-700/50"
          >
            ...
            {teams.map((team, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-gradient-to-br from-brand-primary-500 to-brand-primary-600 rounded-lg">
                      <Users className="w-4 h-4 text-white" />
                    </div>
                    <h3 className="font-semibold text-heading-primary-light dark:text-heading-primary-dark">
                      {team.teamName}
                    </h3>
                  </div>
                ...
                <div className="mb-3">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-txt-secondary-light dark:text-txt-secondary-dark">
                      Completion Rate
                    </span>
                    <span className="text-sm font-bold text-heading-primary-light dark:text-heading-primary-dark">
