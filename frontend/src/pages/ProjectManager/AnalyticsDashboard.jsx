...
const AnalyticsDashboard = ({ projectId }) => {
  // ✅ Memoize the chart cards to prevent recreation on every render
  ...
  // ✅ Memoize the ChartCard component to prevent unnecessary re-renders
  const ChartCard = useMemo(() => 
    ({ title, component, icon, description, color, fullWidth, delay }) => (
      <motion.div
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className={`p-2 rounded-xl bg-gradient-to-br ${color} text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
              {icon}
            </div>
            <div>
    ...
    <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark min-h-full">
      <div className="p-6 lg:p-8">
        ...
        >
          ...
          >
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-4 rounded-xl border border-blue-200/50 dark:border-blue-700/50">
              ...
              <p className="text-2xl font-bold text-blue-800 dark:text-blue-200">75%</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-4 rounded-xl border border-green-200/50 dark:border-green-700/50">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-medium text-green-700 dark:text-green-300">TASKS</span>
              </div>
              <p className="text-2xl font-bold text-green-800 dark:text-green-200">24/32</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-4 rounded-xl border border-purple-200/50 dark:border-purple-700/50">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-medium text-purple-700 dark:text-purple-300">TEAM</span>
              </div>
              <p className="text-2xl font-bold text-purple-800 dark:text-purple-200">8</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 p-4 rounded-xl border border-orange-200/50 dark:border-orange-700/50">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-medium text-orange-700 dark:text-orange-300">DAYS LEFT</span>
              </div>
              <p className="text-2xl font-bold text-orange-800 dark:text-orange-200">12</p>
            </div>
          </motion.div>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-8 p-4 bg-bg-primary-light dark:bg-bg-primary-dark rounded-xl border border-gray-200/20 dark:border-gray-700/20"
        >
