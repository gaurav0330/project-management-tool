          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-brand-primary-200/10 via-brand-secondary-500/5 to-brand-accent-500/10 rounded-3xl p-6 md:p-8 border border-brand-primary-200 dark:border-brand-primary-800">
            ...
            <div className="relative z-10">
              ...
              <p className="text-base md:text-lg leading-relaxed mb-4 text-txt-primary-light dark:text-txt-primary-dark">
                A modern collaboration platform designed to streamline teamwork through AI-powered
                task management, GitHub integration, and seamless communication.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-brand-accent-50 to-brand-accent-100 dark:from-brand-accent-900/20 dark:to-brand-accent-800/20 rounded-2xl p-4 md:p-6 border border-brand-accent-200 dark:border-brand-accent-700">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h4 className="font-heading font-semibold text-brand-accent-700 dark:text-brand-accent-300 text-sm md:text-base">Productivity Boost</h4>
              </div>
              <p className="text-sm md:text-base text-txt-secondary-light dark:text-txt-secondary-dark">
                Increase team productivity and transparency while delivering projects on time.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-brand-secondary-50 to-brand-secondary-100 dark:from-brand-secondary-900/20 dark:to-brand-secondary-800/20 rounded-2xl p-4 md:p-6 border border-brand-secondary-200 dark:border-brand-secondary-700">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h4 className="font-heading font-semibold text-brand-secondary-700 dark:text-brand-secondary-300 text-sm md:text-base">AI-Powered</h4>
              </div>
              <p className="text-sm md:text-base text-txt-secondary-light dark:text-txt-secondary-dark">
                Leverage state-of-the-art AI algorithms for optimal task allocation and team analysis.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                description: "Centralized task and project management with intelligent assignments",
              },
              {
                icon: "🔗",
                title: "GitHub Integration",
                description: "Synchronized repository integration for automatic task updates from commits",
              },
              {
                icon: "💬",
                title: "Real-time Communication",
                description: "Integrated chat, video calls, and group discussions within project teams",
              },
              {
                icon: "📊",
                title: "Analytics Dashboard",
                description: "Detailed project timelines and performance insights for managers",
              },
            ].map((item, index) => (
              <div
                key={index}
          ...
          <div className="bg-gradient-to-r from-brand-primary-50 via-brand-secondary-50 to-brand-accent-50 dark:from-brand-primary-900/10 dark:via-brand-secondary-900/10 dark:to-brand-accent-900/10 rounded-3xl p-6 md:p-8 border-2 border-dashed border-brand-primary-200 dark:border-brand-primary-700 mx-4 md:mx-0">
            <div className="text-center">
              ...
              <p className="text-txt-secondary-light dark:text-txt-secondary-dark max-w-md mx-auto text-sm md:text-base">
                Focus on your work rather than coordinating workflows. Automatic GitHub syncing keeps project statuses current without manual updates.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-6 px-4 md:px-0">
        <div className="text-center mb-8">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-accent-100 to-brand-primary-100 dark:from-brand-accent-900/30 dark:to-brand-primary-900/30 px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-brand-accent-700 dark:text-brand-accent-300 font-medium text-sm">Pro Tips</span>
          </div>
...
const roles = [
  {
    ...
    icon: "👨‍💼",
    description: "Oversees entire projects, sets goals, and assigns leads using AI-powered insights.",
    details: [
  ...
  },
  {
    name: "Team Lead",
    icon: "🧑‍💻",
    description: "Manages sub-teams, delegates tasks, and ensures quality delivery on schedule.",
    details: [
  ...
  },
  {
    name: "Team Member",
    icon: "👤",
    description: "Completes assigned tasks, communicates progress, and submits work for review.",
    details: [
...
const features = [
  {
    ...
    icon: "💬",
    description: "Integrated tools to keep teams connected, informed, and collaborating effectively.",
    points: [
  ...
  },
  {
    ...
    icon: "🐙",
    description: "Seamless synchronization between your project tasks and GitHub repository activities.",
    points: [
  ...
  },
  {
    ...
    icon: "📈",
    description: "Interactive visual insights into project progress and comprehensive team performance.",
    points: [
  ...
  return (
    <div className="group bg-bg-primary-light dark:bg-bg-primary-dark rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 mb-6 md:mb-8 overflow-hidden border-2 border-bg-accent-light dark:border-bg-accent-dark hover:border-brand-primary-200 dark:hover:border-brand-primary-700">
      ...
      >
        ...
        <div className={`transform transition-all duration-500 ${isOpen ? "rotate-180 scale-110" : "rotate-0"} p-2 md:p-3 rounded-2xl bg-gradient-to-br from-brand-primary-100 to-brand-secondary-100 dark:from-brand-primary-900/50 dark:to-brand-secondary-900/50 shadow-lg`}>
          <svg
          ...
          <div className="relative z-10 flex items-center justify-between px-6 sm:px-8 py-6 sm:py-8 border-b-2 border-bg-accent-light dark:border-bg-accent-dark">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-txt-muted-light dark:text-txt-muted-dark">Documentation</p>
              </div>
            </div>
            <button
              type="button"
              ...
              onClick={() => setSidebarOpen(false)}
            >
              <svg className="h-5 w-5 sm:h-6 sm:w-6 text-txt-primary-light dark:text-txt-primary-dark" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                >
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className={`w-0 h-0.5 bg-white rounded-full transition-all duration-300 ${openSectionId === id ? 'w-full' : 'group-hover:w-1/2'}`}></div>
                    </div>
                  </div>
                </button>
              </li>
  ...
  <div className="flex top-4 items-center justify-between px-4 sm:px-6 py-4">
      ...
      <main className="pt-16 lg:ml-72 xl:ml-80 min-h-screen">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-0 py-10 sm:py-12 lg:py-20">
          ...
          {/* Hero Section */}
          <div className={`text-center mb-16 sm:mb-20 px-2 md:px-0 ${animateOnScroll ? 'animate-fade-in' : 'opacity-0'}`}>
            <div className="relative">
              ...
              <div className="relative z-10">
                <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-brand-primary-100 via-brand-secondary-100 to-brand-accent-100 dark:from-brand-primary-900/30 dark:via-brand-secondary-900/30 dark:to-brand-accent-900/30 px-6 py-3 rounded-full mb-8 border border-brand-primary-200 dark:border-brand-primary-700 mx-auto max-w-max">
                  ...
                  <span className="text-brand-primary-700 dark:text-brand-primary-300 font-semibold text-sm sm:text-base">Documentation </span>
                ...
                <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
                  {['AI-Powered', 'GitHub Ready', 'Team Focused'].map((tag, index) => (
                    <span 
                      key={tag}
            ...
            {sections.map(({ id, title, icon, content }, index) => (
              <section 
                ...
                className={`transition-all duration-1000 px-2 md:px-0 ${
                  animateOnScroll ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                }`}
              ...
              >
                <AccordionSection
                  ...
                  onToggle={() => setOpenSectionId(openSectionId === id ? null : id)}
                >
                  {title === "User Roles" ? (
                    <div className="grid gap-6 md:grid-cols-3 mt-4 md:mt-6">
                      {roles.map(({ name, icon, description, details, gradient }, roleIndex) => (
                        <div
                          key={name}
                        ...
                        >
                          ...
                          <div className="relative z-10">
                            <div className="flex items-center space-x-3 md:space-x-4 mb-4 md:mb-6">
                              <div className={`w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br ${gradient} rounded-3xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300`}>
                            ...
                            <ul className="space-y-2 md:space-y-3">
                              {details.map((item, i) => (
                                <li key={i} className="flex items-start space-x-2 md:space-x-3 text-sm md:text-base text-txt-primary-light dark:text-txt-primary-dark leading-relaxed">
                    ...
                    <div className="space-y-8 md:space-y-10 mt-4 md:mt-8">
                      {features.map(({ name, icon, description, points, gradient }, featureIndex) => (
                        <div
                          key={name}
                        ...
                        >
                          ...
                          <div className="relative z-10">
                            <div className="flex items-center space-x-4 md:space-x-6 mb-6 md:mb-8">
                              <div className={`w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br ${gradient} rounded-3xl flex items-center justify-center text-2xl md:text-3xl shadow-2xl group-hover:scale-110 transition-transform duration-300`}>
                                {icon}
                              </div>
                              <div>
                            ...
                            <div className="grid gap-3 md:gap-4">
                              {points.map((point, i) => (
                                <div key={i} className="flex items-start space-x-3 p-4 rounded-2xl bg-bg-primary-light/80 dark:bg-bg-primary-dark/80 hover:bg-bg-primary-light dark:hover:bg-bg-primary-dark transition-all duration-300">
                                  <div className="w-3 h-3 bg-brand-primary-500 rounded-full mt-2 flex-shrink-0"></div>
                                  <span className="text-txt-primary-light dark:text-txt-primary-dark leading-relaxed text-sm md:text-base">{point}</span>
                                </div>
                              ))}
                            </div>
                          </div>
                        ...
                        <div className="space-y-4 md:space-y-6">
                          {[
                            ...
                            <div key={index} className="group flex items-start space-x-4 p-4 md:p-6 bg-bg-primary-light/80 dark:bg-bg-primary-dark/80 rounded-2xl hover:bg-bg-primary-light dark:hover:bg-bg-primary-dark transition-all duration-300 hover:scale-[1.01]">
                              ...
                              <p className="text-txt-primary-light dark:text-txt-primary-dark leading-relaxed text-sm md:text-base">{step}</p>
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="mt-6 md:mt-8 p-4 md:p-6 bg-gradient-to-r from-brand-primary-50 via-brand-secondary-50 to-brand-accent-50 dark:from-brand-primary-900/20 dark:via-brand-secondary-900/20 dark:to-brand-accent-900/20 rounded-2xl border-l-4 border-brand-primary-500">
                          <div className="flex items-start space-x-3">
                            ...
                            <p className="text-brand-primary-800 dark:text-brand-primary-200 leading-relaxed text-sm md:text-base">
                              <strong>Pro Tip:</strong> Make sure your repository has appropriate permissions set for webhook functionality. Test the connection after setup to ensure everything works properly.
                            </p>
                          </div>
                        </div>
                      </div>
